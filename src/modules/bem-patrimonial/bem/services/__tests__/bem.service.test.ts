...
describe('bem.service', () => {
  ...
  it('deve lançar erro com detail da API', async () => {
    const axiosError = new AxiosError('Erro qualquer', '400', undefined, undefined, {
  ...
  it('deve lançar erro padrão quando não houver detail', async () => {
    ...
    await expect(bemService.retrieve(1)).rejects.toThrow('Erro ao buscar detalhes do bem');
  });
  ...
  it('deve lançar erro de conexão quando não houver response', async () => {
    ...
    await expect(bemService.retrieve(1)).rejects.toThrow('Erro de conexão com o servidor.');
  });
  ...
  it('deve criar múltiplos bens', async () => {
    ...
    await expect(bemService.createMulti({ nome: 'Notebook' })).resolves.toBeUndefined();
  });
  ...
  it('deve lançar erro ao falhar createMulti', async () => {
    ...
    await expect(bemService.createMulti({})).rejects.toThrow('Erro ao criar bens');
  });
  ...
  it('deve lançar erro ao falhar list', async () => {
    ...
    await expect(bemService.list({})).rejects.toThrow('Erro ao listar bens');
  });
  ...
  it('deve lançar erro ao falhar update', async () => {
    ...
    await expect(bemService.update(1, {})).rejects.toThrow('Erro ao atualizar bem');
  });
  ...
  it('deve lançar erro ao falhar aprovar', async () => {
    ...
    await expect(bemService.aprovar([1])).rejects.toThrow('Erro ao aprovar bens');
  });
  ...
  it('deve lançar erro ao falhar reprovar', async () => {
    ...
    await expect(bemService.reprovar([1])).rejects.toThrow('Erro ao reprovar bens');
  });
  ...
  it('deve deletar um bem', async () => {
    mock.onDelete('/bens/1/').reply(200);

    await expect(bemService.delete(1)).resolves.toBeUndefined();
  });

  it('deve lançar erro ao falhar delete', async () => {
    const axiosError = new AxiosError('Erro qualquer', '500', undefined, undefined, {
      data: {},
      status: 500,
      statusText: 'Internal Server Error',
    ...
    vi.spyOn(api, 'delete').mockRejectedValueOnce(axiosError);
